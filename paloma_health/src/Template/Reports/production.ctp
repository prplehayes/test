...
<div class="top-header claimhead">
	<h2><i class="icon-files-o"></i><?php echo __('Production Report'); ?></h2>
</div>
<div class="row-fluid show-grid">
	<div class="span12">
     ...
     <div class="nomarginleft span6" style="margin-top:10px;">
		...
		<div class="clear">&nbsp;</div>
		<div><strong>Pending Payment Date</strong></div>
        <div class="clear">&nbsp;</div>
        <div class="control-group">
          <div style="float:left">From :</div>
          <div class="span4"><?php echo $this->Form->input('date_fromp',array('label'=>false,'class'=>'datepicker')); ?> </div>
          <div style="float:left">&nbsp;To :</div>
          <div class="span4"><?php echo $this->Form->input('date_top',array('label'=>false,'class'=>'datepicker')); ?> </div>
        </div>
		<div class="clear">&nbsp;</div>
		<div><strong>Reviewer Approved Date</strong></div>
        <div class="clear">&nbsp;</div>
        <div class="control-group">
          <div style="float:left">From :</div>
          <div class="span4"><?php echo $this->Form->input('date_fromr',array('label'=>false,'class'=>'datepicker')); ?> </div>
          <div style="float:left">&nbsp;To :</div>
          <div class="span4"><?php echo $this->Form->input('date_tor',array('label'=>false,'class'=>'datepicker')); ?> </div>
        </div>
	</div>
      </div>
      <div class="clear">&nbsp;</div>
