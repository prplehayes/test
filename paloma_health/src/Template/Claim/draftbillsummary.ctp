...
<div class="billview1" style="float:left;padding:10px;width:100%;">
	...
	<div class="span12 nomarginleft">
		...
		?>
			...
			<div><strong><?= __('Status ') ?> :</strong> Draft</div>
		</div>
</div>		
<div class="greybg">		
		<div class="clear">&nbsp;</div>
		...
		?>
			<div><strong><?= __('Signature') ?> :</strong> <div class="controls"><?php echo $this->Form->file('signature', ['label'=>false,'div'=>false,'required'=>false]);?></div> </div>
