...
$("#allappealclaimpaidlist .pagination a").on('click', function(e){

        var href = $(this).attr('href');
		
       /* $.ajax({url:href,type: "POST",data:$(".frmfilterpaid").serialize(), success: function(result){
			$("#allappealclaimpaidlist").html(result);         
        }});*/
           $('#allappealclaimpaidlist').load($(this).attr('href'));
       
        return false;
    });
$("#allappealclaimpaidlist .sort a").on('click', function(){
