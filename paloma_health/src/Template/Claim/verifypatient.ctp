...
<div class="patient form view large-9 medium-8 columns content custom_design">
  <div class="top-header patienthead">
						<h2><i class="icon-child"></i><?php echo __('Patient Information'); ?></h2></div>
...
echo $this->Form->select('text_messages_active', $options, ['div'=>false
    ...
    <div class="span6">
      ...
      <div class="control-group">
        ...
        <div class="controls span6"><?php 
		if($RP['dob']=='1/1/1970'){$RP['dob']='';}
		if($RP['dob']!='' && $RP['dob']!='0000-00-00'){
			$RP['dob']=date("m/d/Y",strtotime($RP['dob']));
		}?>
	  <?php echo $this->Form->input('RP.dob', ['value'=>$RP['dob'],'label'=>false,'div'=>false,'type'=>'text','required'=>false,'class'=>'datepicker input','Placeholder'=>'Date of birth']);?></div>
      </div>
      <div class="clear"></div>
    </div>
    <div class="span6">
    ...
    <div class="control-group">
      ...
      <div class="controls span2"><?php echo $this->Form->input('RP.zip', ['value'=>$RP['zip'],'label'=>false,'div'=>false,'type'=>'text','class'=>' input','maxlength'=>5,'Placeholder'=>'Zip Code']);?></div>
    </div>
    <div class="clear"></div>
    <div class="control-group">
      <div class="span2 ">
...
<div class="greybg">
    ...
    <div class="control-group">
      ...
      <div class="span3">
        ...
        <a onclick="PopupCenterDual('<?php echo $this->request->webroot?>uploads/<?php echo $patient->img_photo_id_upload;?>', 'Photo Id',450,450);" title="Photo Id" href="javascript:void(0);"><img src="<?php echo $this->request->webroot?>img/user-bg.png" width="50" height="50">
    ...
    <div class="control-group">
      ...
      <div class="span3">
        <?php if($patient->img_medicare_card!=''){?>
         <a onclick="PopupCenterDual('<?php echo $this->request->webroot?>uploads/<?php echo $patient->img_medicare_card;?>', 'Medical Card Upload',450,450);" href="javascript:void(0);" title="Medical Card Upload"><img src="<?php echo $this->request->webroot?>img/user-bg.png" width="50" height="50">
 ...
 <div class="row-fluid show-grid">	
	...
	<div class="control-group">
      ...
      <div class="controls span3"><?php echo $this->Form->input('PI.average_household_income', ['value'=>$PI['average_household_income'],''=>true,'label'=>false,'div'=>false,'type'=>'text','class'=>' input']);?></div>
      <div class="clear"></div>
...
<div class="greybg">
    ...
    <div class="control-group">
        ...
        <div class="controls span3"><?php echo $this->Form->input('PPP.first_name',['value'=>$PPP['first_name'],'label'=>false,'required'=>false,'div'=>false,'class'=>'input','Placeholder'=>'First Name']);?></div>
        ...
        <div class="controls span3"><?php echo $this->Form->input('PPP.last_name', ['value'=>$PPP['last_name'],'label'=>false,'required'=>false,'div'=>false,'class'=>'input','Placeholder'=>'Last Name']);?></div>
    </div>
    <div class="control-group">
      <div class="span2">
        <label class="control-label">
      ...
      <div class="controls span3"><?php echo $this->Form->input('PPP.address_1', ['value'=>$PPP['address_1'],'label'=>false,'div'=>false,'required'=>false,'type'=>'text','class'=>' input','Placeholder'=>'Street Address']);?></div>
      <div class="span2">
        <label class="control-label">
        <?= __('City') ?>
        </label>
      </div>
      <div class="controls span3"><?php echo $this->Form->input('PPP.city', ['value'=>$PPP['city'],'label'=>false,'div'=>false,'type'=>'text','required'=>false,'class'=>' input','Placeholder'=>'City']);?></div>
    </div>
    <div class="clear"></div>
    <div class="control-group">
      ...
      <div class="controls span3"><?php echo $this->Form->input('PPP.state', ['value'=>$PPP['state'],'options'=>$states,'empty'=>"Select",'label'=>false,'div'=>false,'required'=>false,'class'=>' input','Placeholder'=>'State']);?></div>
      <div class="span2">
        <label class="control-label">
        <?= __('Zip Code') ?>
        </label>
      </div>
      <div class="controls span3"><?php echo $this->Form->input('PPP.zip', ['value'=>$PPP['zip'],'label'=>false,'div'=>false,'type'=>'text','maxlength'=>5,'required'=>false,'class'=>' input','Placeholder'=>'Zip Code']);?></div>
    </div>
    <div class="clear"></div>
    <div class="control-group">
      <div class="span2">
