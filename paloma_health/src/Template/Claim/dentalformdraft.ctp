<div class="claim form large-9 medium-8 columns content">
    ...
    <fieldset>
		...
		<?php
			...
			<label for="dental_verification_upload">Medical Verification Upload</label><?php echo $this->Form->file('dental_verification_upload',['label' => 'Medical Verification Upload','required'=>false]);?>
			</div>
			<div class="clear"><br></div>
			<div class="input text">
			<label for="progress_notes_upload">Progress Notes Upload</label><?php echo $this->Form->file('progress_notes_upload',['label' => 'Progress Notes Upload','required'=>false]);?>
			</div>
