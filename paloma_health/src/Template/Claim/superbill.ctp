 ...
 <br/>
  <?php
    ...
    <div class="input select cptlist">
      ...
      <?php
            echo $this->Form->input('cpt_codes._ids[]',['options' => $cptCodes,'empty'=>true,'value'=>'','div' => false,'label'=>false,'required'=>true,'class'=>'cptcodes']);
			?>
...
<div class="greybg" style="padding-left:8.382978723%">
  <div class="field_wrapper2">
    <div class="input select icd10list">
      ...
      <?php
            echo $this->Form->input('icd10_codes._ids[]',['options' => $icd10Codes,'empty'=>true,'value'=>'','label'=>false,'required'=>true,'class'=>'icd10codes']);
			?>
  ...
  <?php
           ...
           // echo $this->Form->input('signature');
            echo $this->Form->input('date_of_service',['type'=>'text','required'=>true,'class'=>'datepicker']);
