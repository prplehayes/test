        ...
        <thead>
           <tr>
               <th width="80px"><input type="checkbox" name="chkallc" id="chkallc" value="1">
              &nbsp;All</th>
        ...
        <tbody>
            ...
            <tr>
               <td>
			<input type="checkbox" name="clid[]" class="chkc" value="<?php echo $claim->id?>">
			</td>
...
$("#allcorrectionreview .pagination a").on('click', function(e){
	...
	$("#allcorrectionreview").html(result);         
            ...
            //$('#allcorrectionreview').load($(this).attr('href'));
       
        return false;
    });
$("#allcorrectionreview .sort a").on('click', function(){
