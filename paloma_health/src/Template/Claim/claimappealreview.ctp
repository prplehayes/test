    ...
    <div class=" nomarginleft">
      <div class="span4 nomarginleft"><strong>
		...
		<?php
		  ...
		  <?php echo $this->Form->file('dental_verification_upload', ['label'=>false,'div'=>false]);?> <?php echo $this->Form->hidden('h_dental_verification_upload', ['value'=>$patient->dental_verification_upload]);?>
        </div>
      </div>
...
<div >		  
          ...
          <div class="span6 nomarginleft"><br><br>
...
echo $this->Form->select('appeal_status', $options, ['empty'=>'Select Option',
    'div'=>false,'value'=>$appealpayment->appeal_status
]);
			?>
			...
			<div class="span3 nomarginleft">
 				$<?php echo $appealpayment->pay_amount?>
  </div>
  <div class="clear">&nbsp;</div>
  			<div class="span4 nomarginleft"> <strong>
			...
			<div class="span6 nomarginleft">
 				<?php echo $appealpayment->reason_notes?>
  </div>
			</div>
        </div>
      </div>
  ...
  <div style="float:left;margin-left:30px;">
    <?= $this->Form->button(__('Submit'),['class'=>'btn-primary']) ?>&nbsp;&nbsp;<a href="<?php echo $this->request->webroot?>claim/allclaimreview" class="btn-blue button btn-large backbtn">Back</a>
  </div>
  <?= $this->Form->end() ?>
  <br>
  <br>
