...
<div class="patient form large-9 medium-8 columns content custom_design">
 <div class="top-header patienthead">
						<h2><i class="icon-user-plus"></i><?php echo __('Edit Patient'); ?></h2></div>
  ...
  <div class="">
    ...
    <div class="control-group">
	  ...
	  <?php echo $this->Form->input('dob', ['value'=>date("m/d/Y",$patient->dob),'label'=>false,'div'=>false,'type'=>'text','class'=>'datepicker input','Placeholder'=>'Date of birth']);?>
...
echo $this->Form->select('text_messages_active', $options, ['div'=>false
    ...
    <div class="span6">
	  ...
	  <?php echo $this->Form->input('RP.dob', ['value'=>$RP['dob'],'label'=>false,'div'=>false,'type'=>'text','class'=>'datepicker input','required'=>false,'Placeholder'=>'Date of birth']);?>
    ...
    <div class="control-group">
      ...
      <div class="controls span2"><?php echo $this->Form->input('RP.zip', ['value'=>$RP['zip'],'label'=>false,'div'=>false,'type'=>'text','maxlength'=>5,'class'=>' input','Placeholder'=>'Zip Code']);?></div>
    </div>
    <div class="clear"></div>
    <div class="control-group">
      <div class="span2 ">
	...
	<div class="control-group">
      ...
      <div class="span3">
        <?php if($patient->registration_form_upload!=''){?>
         <a onclick="PopupCenterDual('<?php echo $this->request->webroot?>uploads/<?php echo $patient->registration_form_upload;?>', 'Registration Form',450,450);" href="javascript:void(0);"   title="Registration Form"><img src="<?php echo $this->request->webroot?>img/user-bg.png" width="50" height="50">
...
<?php 
  ...
  <div class="clear"></div>
    ...
    <div class="control-group">
      ...
      <div class="controls span3"><?php echo $this->Form->input('PPP.phone', ['value'=>$PPP['phone'],'label'=>false,'div'=>false,'required'=>false,'type'=>'text','class'=>' input','Placeholder'=>'Phone']);?></div>
	  <div class="span2">
        <label class="control-label">
        <?= __('FAX') ?>
        </label>
  ...
  <div style="float:left">
    <?= $this->Form->button(__('Submit'),['class'=>'btn-primary btnsavepatient']) ?>
  </div>
  <?= $this->Form->end() ?>
</div></div>
